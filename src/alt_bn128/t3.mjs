import { poseidon } from '../index.mjs'
import { F } from './field.mjs'
...
].map((v) => v.map(parseBase64))

function parseBase64(o) {
...
export const poseidonT3 = (input) =>
  poseidon(input, { C, M, N_ROUNDS_P, N_ROUNDS_F, F })
